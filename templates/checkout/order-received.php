...
<?php if ($order) : ?>
    <?php
        ...
        $billing_address_data = [
            ...
            'comuna'     => $order->get_billing_city() ?: get_post_meta($order->get_id(), 'billing_comuna', true),
        ...
        $shipping_address_data = [
            ...
            'comuna'     => $order->get_shipping_city() ?: get_post_meta($order->get_id(), 'shipping_comuna', true),
